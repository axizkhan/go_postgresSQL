...
SELECT id, name, dob, created_at, updated_at FROM users WHERE id = $1 LIMIT 1
`
...
SELECT id, name, dob, created_at, updated_at FROM users ORDER BY id LIMIT $1 OFFSET $2
`
